...
export default function App() {
  ...
  const [selectedAirline, setSelectedAirline] = useState<AirlineDataWithFlightsUi | null>(null);
  ...
  const [airportData, airportDataLoading] = useAirportDetails(userLimits, selectedAirport);
    ...
    <>
      <Box display={'flex'} flexDir={'column'}>
        ...
        <Text fontSize={{ base: 'small', sm: 'medium' }} fontWeight={'bold'}>
          You can use this application to randomly select a flight from one airport with a specific airline.
        </Text>
        ...
        <Box>
          <Button
            ...
            isDisabled={airportDataLoading || selectedAirport == null || selectedAirline == null}
